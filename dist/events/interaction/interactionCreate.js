...
import { buildPurchaseSelectionPayload, createLicenseTicket, createPurchaseTicket, handleTicketClose, } from "../../services/ticketService.js";
            ...
            if (interaction.isButton()) {
                if (interaction.customId === CustomIds.feedbackOpenModalButton) {
                    ...
                    const feedbackInput = new TextInputBuilder()
                        ...
                        .setRequired(true);
                    modal.addComponents(new ActionRowBuilder().addComponents(licenseInput), new ActionRowBuilder().addComponents(feedbackInput));
